      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <form class="navbar-form navbar-right" role="form">
            ...
            <button type="button" class="btn btn-info" onclick="window.location.href='cadastro.html'">Cadastrar-se</button>
          </form>
        </div><!--/.navbar-collapse -->
      </div>
    </nav>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12" >
              ...
              <span>
                <form name="frmBusca" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>?a=buscar" style="padding-bottom: 300px;" >
