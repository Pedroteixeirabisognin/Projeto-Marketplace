    ...
    <head>
        ...
        <script>
          $(document).ready( function(){
            ...
            // VERIFICAR SE OS CAMPOS DE USUÁRIO E SENHA FORAM DIGITADOS CORRETAMENTE
            $('#login_botao').click(function(){
              alert('Funfou ate aqui');
              if($('#login_vazio').val == ''){
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <form method="post" action="php/dao/verificar_login.php" class="navbar-form navbar-right" role="form">
            <div class="form-group">
              <input type="text" placeholder="Login" class="form-control" id="login_vazio"  name="login_verifica">
            </div>
            <div class="form-group">
              <input type="password" placeholder="Password" class="form-control"  placeholder="Password" id="senha_vazia"  name="senha_verifica">
            </div>
